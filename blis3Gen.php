 ...
 * Connect to database
 */
include('blis3TestsGen.php');
$servername = "blis3.local";
$username = "root";
$password = "1234";
$database= "blis3";
...
// "control_results", "control_tests","control_measure_ranges","control_measures","control_types","lots",
    // "instruments",
    // "patients", 
    "specimens", 
...
// todo: write this in its proper place
...
use App\Models\\".$modelName.";\n\n";
    ...
    $stored_fields="            $".lcfirst($modelName)." = new ".$modelName.";\n";
        ...
        $myfile = fopen("/var/www/Blis-V3/app/Http/Controllers/".$modelName."Controller.php", "w") or die("Unable to open file!");
